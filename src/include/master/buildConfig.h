 ...
 */ 
    ...
    #define 	BLD_EJS_LIBS "ajs pcre mprssl libeay32 ssleay32 libmatrixssl mpr sqlite3"
    #define 	BLD_EJS_OPTIONAL_DEPENDENCIES "ssl sqlite"
    #define 	BLD_EJS_WITH "1"
    #define 	BLD_EJS_WITHLIBS "pcre mprssl libeay32 ssleay32 libmatrixssl mpr sqlite3"
